...
public class TeacherPeerReviewController {

    private final JwtTokenProvider jwtTokenProvider;
    private final PeerReviewService peerReviewService;

    public TeacherPeerReviewController(JwtTokenProvider jwtTokenProvider, PeerReviewService peerReviewService) {
        this.jwtTokenProvider = jwtTokenProvider;
        this.peerReviewService = peerReviewService;
    }

    /** 教师查看某组互评（与学生端相同的匿名代号，无身份映射） */
    ...
    public ApiResponse<List<PeerReviewAnonymousItem>> list(
        ...
        return ApiResponse.success(peerReviewService.listForTeacher(teacherId, classId, taskId, groupId));
    }
